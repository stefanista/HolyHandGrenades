...
import { SurveyJS } from './survey';

describe('Service: SurveyJS', () => {

	let service: SurveyJS;
	let httpMock: HttpTestingController;
	let accessKey: "c0499c368aed4767bc35f46dc16e9925";
	...
	beforeEach(() => {
		TestBed.configureTestingModule({
			...
			providers: [
				{ provide: SurveyJS, useClass: SurveyJS },
			],
		})
		service = TestBed.get(SurveyJS);
